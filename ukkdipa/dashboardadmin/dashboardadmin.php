...
<body>
    <a class="navbar-brand">
        <img src="../assets/lgoo.png" alt="logo" width="130px">
    </a>
    ...
    <div class="mt-5 p-4">
        ...
        <div class="mt-4 p-3">
            <div class="d-flex flex-wrap justify-content-center gap-2">
                ...
                <div class="cardImg">
                    <button onclick="location.href='akunPetugas/buatakunpetugas.php';" class="btn-custom btn-akun">Buat Akun Petugas</button>
                </div>
                <div class="cardImg">
